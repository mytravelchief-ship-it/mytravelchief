            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-20 mb-15">
               <div className="col-span-1 lg:col-span-1">
                  ...
                  <div className="flex gap-4">
                     <a
                        href="#"
                        className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-brand-gold hover:text-brand-black transition-all duration-500 border border-white/10"
                     >
