...
const VEHICLES: Vehicle[] = [
   {
      ...
      image: 'https://res.cloudinary.com/db41bfixa/image/upload/v1773575292/Sedan-Cars1-1024x576_hnsbnt.png',
   ...
   {
      id: 'tempo-9-12',
      name: 'Tempo Traveler 09-12 Seater',
      type: 'Van',
      seats: 12,
      label: '09-12 Seats',
...
const SERVICES = [
   {
      ...
      description:
         'Arriving at Cochin International Airport? Our drivers track your flight and ensure on-time pickup, even during delays. Ideal for tourists, business travelers, and families.',
      icon: Plane,
   ...
   },
   {
      ...
      description:
         'Custom-designed Kerala travel packages covering hill stations, backwaters, beaches, wildlife, and heritage locations.',
      icon: Mountain,
   ...
   },
   {
      ...
      description:
         'Perfect for city travel, shopping trips, meetings, hotel transfers, and hourly rentals within Kochi and Ernakulam.',
      icon: MapPin,
   ...
   },
   {
      ...
      description:
         'Comfortable long-distance travel to popular destinations like: Munnar, Alleppey, Thekkady, Wayanad, Varkala & Kovalam',
      icon: Car,
   ...
   return (
      <div className={`flex items-center gap-3 ${className}`}>
         <div className="relative w-16 h-16 flex items-center justify-center">
            <img
               src="https://res.cloudinary.com/db41bfixa/image/upload/q_auto/f_auto/v1776075179/image-removebg-preview_zimjfs__1_-removebg-preview_xdxmk3.png"
         ...
         <div className="flex flex-col leading-none text-left">
            <span
               className={`text-xl font-display font-black uppercase tracking-[-0.05em] ${light ? 'text-white' : 'text-brand-black'}`}
            >
               TRAVEL <span className="text-brand-gold">CHIEF</span>
            </span>
            <span
               className={`text-[7px] font-bold uppercase tracking-[0.3em] ${light ? 'text-white/60' : 'text-brand-black/40'}`}
            >
               The World On Wings
            </span>
         </div>
   ...
   return (
      <a
         ...
         className={
            children
               ? ''
               : 'text-[10px] font-bold uppercase tracking-[0.2em] transition-all hover:text-brand-gold text-white/70 hover:tracking-[0.3em]'
         }
      >
         {children || name}
      </a>
...
const Navbar = () => {
   ...
   return (
      <header
         className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? 'bg-brand-black/95 backdrop-blur-md border-b border-white/5 py-3' : 'bg-transparent py-6'}`}
      >
               ...
               >
                  <ul className="p-8 space-y-6">
                     ...
                     <div className="grid grid-cols-2 gap-4 pt-6 border-t border-white/5">
                        <a
                           href="https://wa.me/917559917686"
                           className="bg-brand-gold text-brand-black p-4 rounded-xl flex items-center justify-center gap-2 font-black text-[10px] uppercase tracking-widest"
                        >
                           <MessageCircle size={18} /> WhatsApp
                        </a>
                        <a
                           href="tel:+917559917686"
                           className="bg-white/5 text-white p-4 rounded-xl flex items-center justify-center gap-2 font-black text-[10px] uppercase tracking-widest border border-white/10"
                        >
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-10 overflow-hidden bg-brand-black">
         ...
         <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-5xl mx-auto text-center">
               ...
               >
                  Experience Kerala like never before with our most trusted premium taxi service. From airport transfers to luxury
                  group tours, we provide the wings for your journey.
               </motion.p>
               ...
               >
                  {[
                     {
                        name: 'Tourist Taxi',
                        img: 'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&q=80&w=100',
                     },
                     {
                        name: 'Airport Pickup',
                        img: 'https://images.unsplash.com/photo-1436491865332-7a61a109c0f2?auto=format&fit=crop&q=80&w=100',
                     },
                     {
                        name: 'Sabarimala Packages',
                        img: 'https://images.unsplash.com/photo-1623944889288-cd147dbb517c?auto=format&fit=crop&q=80&w=100',
                     },
                     {
                        name: 'Group Tours',
                        img: 'https://images.unsplash.com/photo-1539635278303-d4002c07dee3?auto=format&fit=crop&q=80&w=100',
                     },
                  ].map(tag => (
                     <span
                        key={tag.name}
                        className="text-[10px] font-black uppercase tracking-[0.2em] flex items-center gap-3 text-brand-gold"
                     >
                        {tag.name}
                     </span>
                  ))}
...
const PACKAGE_TARIFFS = [
   ...
   {
      id: 'tempo-9-12',
      name: 'Tempo Traveller 09-12 Seater',
      passengers: 12,
      extraKm: '24/Km',
      packages: [
      ...
      <div className="mt-8">
                     ...
                     <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                           ...
                           <span className="text-white/30 text-[10px] font-bold uppercase tracking-widest">
                              {vehicle.passengers} Passengers &middot; AC &middot; Extra {vehicle.extraKm}
                           </span>
                        </div>
                     </div>
                     <ChevronDown
         ...
         <div className="mt-10 max-w-4xl mx-auto">
            <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-6">
               <h4 className="text-brand-gold font-display font-bold text-sm uppercase tracking-widest mb-4">
               ...
               <ul className="space-y-3 text-white/60 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                     <span className="w-2 h-2 rounded-full bg-brand-gold mt-1.5 flex-shrink-0"></span>
                     <span>Extra Km charges will be applicable as per vehicle type.</span>
                  </li>
                  <li className="flex items-start gap-3">
                     <span className="w-2 h-2 rounded-full bg-brand-gold mt-1.5 flex-shrink-0"></span>
                  ...
                  <li className="flex items-start gap-3">
                     <span className="w-2 h-2 rounded-full bg-brand-gold mt-1.5 flex-shrink-0"></span>
                     <span>Kilometre Counting From Pickup to Pickup OR Kilometres Calculation from Garage to Garage.</span>
                  </li>
               </ul>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
               {VEHICLES.map(vehicle => (
                  ...
                  >
                     ...
                     <div className="p-5">
                        <h3 className="text-lg font-display font-black uppercase tracking-tight text-white mb-3">
                           {vehicle.name}
                        </h3>
      ...
      <section id="about" className="py-10 bg-brand-black relative overflow-hidden">
         <div className="container mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-24 items-center">
               <div className="relative">
                  ...
                  <div className="absolute -bottom-10 -right-10 bg-brand-gold p-10 rounded-3xl shadow-2xl max-w-xs hidden md:block">
                     <div className="flex items-center gap-4 mb-6">
                        <div className="w-14 h-14 bg-brand-black rounded-2xl flex items-center justify-center text-brand-gold font-black text-2xl">
                           5.0
                        </div>
                        <div>
               ...
               <div>
                  <span className="text-brand-gold font-black uppercase tracking-[0.4em] text-[10px] mb-6 block">
                     Why Choose Travel Chief?
                  </span>
                  ...
                  <p className="text-white/40 text-lg mb-12 leading-relaxed font-medium">
                     Best Taxi Service in Kochi for International Travelers, North Indians & Tourists. Trusted, professional cab
                     services tailored for airport transfers, city tours, and long-distance journeys.
                  </p>
                  <div className="grid sm:grid-cols-2 gap-12">
                     {features.map((f, i) => (
                        <div key={i} className="group flex gap-6">
                           ...
                           <div>
                              <h4 className="font-display font-bold text-white mb-2 uppercase tracking-tight text-sm group-hover:text-brand-gold transition-colors">
                                 {f.title}
                              </h4>
                              <p className="text-[11px] text-white/30 font-medium leading-relaxed group-hover:text-white/50 transition-colors">
                                 {f.desc}
                              </p>
                           </div>
                        </div>
            ...
            >
               ...
               <div className="flex flex-wrap justify-center gap-12 mb-10">
                  {['Comfortable Rides', 'On-Time Pickup', 'Expert Support'].map(item => (
                     <div
                        key={item}
                        className="flex items-center gap-3 text-white/40 font-black uppercase tracking-[0.2em] text-[10px]"
                     >
               ...
               <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                  ...
                  >
                     <div className=" rounded-2xl bg-[#25D366] flex items-center justify-center shadow-[0_8px_30px_rgba(37,211,102,0.3)] group-hover:scale-110 group-hover:shadow-[0_8px_40px_rgba(37,211,102,0.5)] transition-all duration-300">
                     ...
                     >
                        <div className="bg-white/[0.03] rounded-3xl overflow-hidden border border-white/10 hover:border-brand-gold/30 transition-all duration-500 shadow-2xl hover:shadow-brand-gold/5">
                           ...
                           <div className="p-6">
                              ...
                              <p className="text-white/50 text-sm leading-relaxed mb-5 italic">&ldquo;{review.quote}&rdquo;</p>
         ...
         <div className="container mx-auto px-6 max-w-4xl relative z-10">
            ...
            <div className="space-y-4">
               {FAQS.map((faq, i) => (
                  <div
                     key={i}
                     className="bg-white/5 rounded-3xl overflow-hidden border border-white/5 transition-all hover:border-white/10"
                  >
                     <button
                        onClick={() => setOpenIdx(openIdx === i ? null : i)}
                     ...
                     >
                        <span
                           className={`font-display font-bold uppercase tracking-tight transition-colors ${openIdx === i ? 'text-brand-gold' : 'text-white/70 group-hover:text-white'}`}
                        >
                           {faq.q}
                        </span>
                        <div
                           className={`w-10 h-10 rounded-2xl flex items-center justify-center transition-all ${openIdx === i ? 'bg-brand-gold text-brand-black' : 'bg-white/5 text-white/40'}`}
                        >
                           <ChevronDown
                              size={20}
                              className={`transition-transform duration-500 ${openIdx === i ? 'rotate-180' : ''}`}
                           />
                        </div>
                     </button>
                     <AnimatePresence>
                  ...
                  <div className="space-y-8">
                     ...
                     <div className="flex gap-4 sm:gap-8 group">
                        ...
                        <div>
                           ...
                           <p className="text-white font-display font-bold text-base sm:text-xl break-all sm:break-normal">
                              mytravelchief@gmail.com
                           </p>
                           <p className="text-white font-display font-bold text-base sm:text-xl break-all sm:break-normal">
                              support@travelchief.in
                           </p>
                        </div>
                     </div>
                  </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-20 mb-15">
               <div className="col-span-1 lg:col-span-1">
                  ...
                  <p className="text-white/30 text-sm leading-relaxed mb-10 font-medium max-w-xs">
                     Kochi's most reliable cab and tour provider. We specialize in airport transfers, local city rides, and
               ...
               <div>
                  ...
                  <ul className="space-y-5 text-white/40 text-[10px] font-black uppercase tracking-[0.2em]">
                     ...
                     <li>
                        <Link to="/tariff" className="hover:text-brand-gold transition-colors">
                           Fleet
                        </Link>
                     </li>
                     <li>
               ...
               <div>
                  ...
                  <ul className="space-y-8 text-white/40 text-sm font-medium">
                     ...
                     <li className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                           <span className="text-white font-black"> mytravelchief@gmail.com</span>
...
const FloatingButtons = () => {
   ...
   return (
      <div
         className={`fixed right-5 bottom-6 z-50 flex flex-col gap-3 transition-all duration-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0 pointer-events-none'}`}
      >
         {/* Call */}
         <a href="tel:+917559917686" className="group relative flex items-center justify-end">
         ...
         {/* WhatsApp */}
         <a href="https://wa.me/917559917686" className="group relative flex items-center justify-end">
            <span className="absolute right-full mr-3 bg-brand-black/90 backdrop-blur-md text-white text-xs font-bold px-4 py-2 rounded-xl border border-white/10 whitespace-nowrap opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0 transition-all duration-300 pointer-events-none shadow-xl">
               WhatsApp Us
            </span>
      ...
      <div className="fixed right-1 sm:right-2 top-0 bottom-0 z-40 w-6 sm:w-8 flex flex-col items-center pointer-events-none">
         ...
         >
            <div
               ...
               style={{
                  backgroundImage:
                     'repeating-linear-gradient(to bottom, rgba(212,175,55,0.25) 0px, rgba(212,175,55,0.25) 8px, transparent 8px, transparent 20px)',
               }}
            />
            <div
